                ...
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Cher(e) <b>{{ $userName }}</b>,<br>
                        ...
                        Nous sommes ravis de vous informer que votre compte a été activé avec succès sur notre plateforme de gestion des congés. Vous pouvez désormais accéder à toutes les fonctionnalités de notre application.
