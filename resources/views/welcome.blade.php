                              ...
                              <div class="carousel-caption relative">
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="dream">
                                          <h1>
                                             Libérez la simplicité et <br>gérez les congés <br>avec facilité
                                          </h1>
                                          <a class="read_more" href="{{route('login')}}">Se connecter</a>    
                                          <a class="read_more" href="{{route('register')}}">S'identifier</a>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="dream_img">
                                          <figure><img src="{{ url('Image/principale.png') }}" alt="#"/></figure>
                                       </div>
                                    </div>
                                 </div>
                              </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage text_align_center">
                     <h2>NOUS GARANTISSONS <span class="blue_light">LA QUALITÉ</span></h2>
                     <p> 
                     </p>
                  </div>
               </div>
               ...
               <div class="col-lg-4 col-md-6">
                  <div id="ho_co" class="guarantee-box_main">
                     <div class="guarantee-box text_align_center">
                        ...
                        <h3>Accès web</h3>
                        <p>Accédez facilement à votre application de gestion des congés de n'importe où, simplifiant ainsi la soumission et le suivi des demandes, offrant une gestion pratique et efficace des congés en toute mobilité.</p>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-lg-4 col-md-6">
                  <div id="ho_co" class="guarantee-box_main">
                     <div class="guarantee-box text_align_center">
                        ...
                        <p>La sécurité de vos données est notre engagement absolu. Notre application de gestion des congés utilise des mesures de cryptage avancées pour garantir la confidentialité et la protection de vos informations personnelles.</p>
                     </div>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6">
                  <div id="ho_co" class="guarantee-box_main">
                     <div class="guarantee-box text_align_center">
                        ...
                        <h3>Garantie</h3>
                        <p>Notre application de gestion des congés assure une traçabilité sans faille des demandes, offrant aux employés simplicité et aux gestionnaires un outil fiable. Une garantie d'efficacité dans la gestion des congés au service de votre entreprise.</p>
                     </div>
                  </div>
               </div>
            </div>
